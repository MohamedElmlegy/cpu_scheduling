...
namespace WindowsFormsApp1
{
    ...
    public partial class Form5 : Form
    {
        ...
        public Form5()
        {
            ...
            type = "";
            no_prc = 0;
            //form1_with_chart = new Size(1166, 556);
            id = new List<int>();
            arrival = new List<int>();
            burst = new List<int>();
            priorty = new List<int>();
            @out = new List<List<int>> {new List<int> {0,0,0},
                                        new List<int> {0,0,0},
                                        new List<int> {0,0,0},
                                        new List<int> {0,0,0},
                                        new List<int> {0,0,0},
                ...
                case "Priority (Non Preemptive)":
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            if (this.Size.Height < 453 || this.Size.Width < 886)
                            {
                                this.Size = new Size(886, 453); ;
                            }
                            chart1.Series.Clear();
                            chart1.Show();
                ...
                case "Round Robin":
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            sort_process_by_arrival(p_id, p_arrival, p_burst);
                            add_process_in_chart();
                            roundrobin(@out, ilist_to_iarray( p_arrival), ilist_to_iarray (p_burst), this.quant, this.no_prc, ref this.avg_waiting_t);
                            round_robin_chart(@out);
                            textBox5.Text = this.avg_waiting_t.ToString("0.00");
        ...
        private void roundrobin(List<List<int>> @out, int[] at, int[] bt, int quant, int nop , ref double avg_wt)
        {
        ...
        private void round_robin_chart (List<List<int>> o)
        {
            ...
            for (int i = 0; i < o.Count; i++)
            {
                ...
                chart1.Series[0].Points.AddXY(o[i][0], o[i][1], o[i][ 2]);
